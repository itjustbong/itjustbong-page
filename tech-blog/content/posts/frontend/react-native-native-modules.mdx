---
title: "커스텀 네이티브 모듈 만들기"
description: "React Native에서 직접 네이티브 모듈을 만들어 JS와 통신하는 방법을 알아봅니다"
category: "frontend"
...
React Native에서 제공하는 기본 모듈 외에도, 직접 네이티브 모듈을 만들어 JS 코드와 통신할 수 있습니다. 이 문서에서는 Expo Modules API를 활용한 커스텀 네이티브 모듈 개발 방법을 알아봅니다.
...
- **특수 하드웨어 연동**: 블루투스, IoT 등
- **기존 SDK 활용**: 결제, 광고 SDK
- **성능 최적화**: 고성능 작업을 네이티브에서 처리

Expo Modules API를 사용하면 Swift/Kotlin으로 쉽게 네이티브 모듈을 만들 수 있습니다! 🚀
