---
title: "Metro 서버와 Hot Reload 원리"
description: "React Native의 핵심 번들러 Metro 서버의 역할과 Hot Reload가 작동하는 원리를 알아봅니다"
category: "frontend"
...
React Native 개발에서 빠른 개발 경험을 제공하는 핵심은 Metro 서버와 Hot Reload입니다. 이 문서에서는 Metro 서버의 역할과 Hot Reload가 어떻게 작동하는지 자세히 설명합니다.
...
Metro 서버와 Hot Reload는 React Native 개발의 핵심입니다:

- **Metro 서버**: JavaScript 번들러 + 실시간 코드 전송
- **Hot Reload**: JS 코드만 교체하여 빠른 개발 가능
- **Development Build**: 네이티브는 한 번 빌드, JS는 무한 수정

이 개념을 이해하면 왜 개발이 빠른지, 왜 배포 시에는 빌드가 필요한지 명확히 알 수 있습니다! 🚀
