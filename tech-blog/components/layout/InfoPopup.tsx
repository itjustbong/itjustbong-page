...
import { developerSites, socialLinks } from "@/lib/site-data";
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          ref={popupRef}
          className="absolute right-0 top-full mt-3 w-72 origin-top-right animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 rounded-xl border border-border/50 bg-background/95 p-5 shadow-xl backdrop-blur-md duration-200"
        >
          {/* 개발자의 사이트 */}
          <div className="mb-5">
