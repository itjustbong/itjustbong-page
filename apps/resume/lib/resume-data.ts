...
export const techStacks: TechStack[] = [
  {
    ...
    description:
      "**FSD/AsyncBoundary 기반 구조 설계**, 로딩/에러 UX 개선. **반응형/다국어/공통 컴포넌트 설계** 경험.",
  },
  {
    category: "Backend",
    icon: "server",
  ...
  },
  {
    ...
    description:
      "다양한 **AI IDE/Agents 실무 활용**. 기본적인 **RAG 구축/실험** 경험 보유.",
  },
];
    ...
    projects: [
      {
        ...
        highlights: [
          ...
          "**Unity WebGL 임베딩 최적화**: 페이지 이동 후 Unity 인스턴스 메모리 점유 문제를 **생명주기 제어**로 해결, 로딩 Overlay 추가 및 프론트엔드-Unity 간 **메시지 프로토콜 정의로 실행 컨텍스트 동기화** 구현",
        ],
      },
      {
...
export const personalProjects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      "**풀스택 모노레포 구축**: Turborepo 기반 NestJS 백엔드 + Next.js 프론트엔드 운영, **Python ETL 파이프라인**으로 SEC EDGAR XML 파싱 및 PostgreSQL 적재",
  ...
  },
  {
    ...
    highlights: [
      "**모노레포 아키텍처**: Turborepo + pnpm workspace 기반 apps(blog/resume/llm) + packages(ui/shared/config) 구조, **공유 패키지**로 여러 Next.js 앱 간 **재사용성 및 개발 효율 향상**",
  ...
  },
  {
    ...
    highlights: [
      "**이미지 저장/트래픽 비용 최적화**: AWS S3에서 Cloudflare Images로 전환, 업로드 용량 제한(10MB) 및 화면별 해상도 최적화(image variant) 적용으로 **월 비용 $32+ → $5 수준으로 절감**",
